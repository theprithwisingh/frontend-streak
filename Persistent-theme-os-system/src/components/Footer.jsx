...
const Footer = () => {
  return (
    ...
    <footer className="px-6 py-10 border-t border-[var(--border)] bg-[var(--bg)] text-[var(--text)]">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mb-3">
            Building scalable web platforms worldwide.
          </p>
      ...
      <div className="mt-10 border-t border-[var(--border)] pt-4 text-center text-xs bg-[var(--bg)] text-[var(--text)] opacity-70">
