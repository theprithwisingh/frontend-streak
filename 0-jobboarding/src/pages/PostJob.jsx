        ...
        <div className="min-h-screen bg-gray-50 py-10 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-black">Post a New Job</h1>
                    <p className="mt-1 text-gray-500">Fill in the details below to list a new position</p>
                </div>
